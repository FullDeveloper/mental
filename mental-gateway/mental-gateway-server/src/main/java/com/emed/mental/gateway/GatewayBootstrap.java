package com.emed.mental.gateway;
...
/**
 * @Author: 周润斌
 * @Date: create in 上午 12:47 2018/2/1 0001
 * @Description:
 */
...
@EnableAuthClient
@EnableFeignClients({"com.emed.mental.auth.client.feign","com.emed.mental.gateway.feign"})
