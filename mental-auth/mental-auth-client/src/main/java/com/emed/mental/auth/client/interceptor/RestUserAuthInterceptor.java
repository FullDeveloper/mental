...
import com.emed.mental.auth.client.annotation.IgnoreUserToken;
...
/**
 * @Author: 周润斌
 * @Date: create in 上午 13:54 2018/2/2 0002
 * @Description:
 */
public class RestUserAuthInterceptor extends HandlerInterceptorAdapter {
    private Logger logger = LoggerFactory.getLogger(RestUserAuthInterceptor.class);
